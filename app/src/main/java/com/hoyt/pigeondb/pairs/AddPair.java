...
ArrayList<Pigeons>p=new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference rc = FirebaseDatabase.getInstance().getReference(FirebaseAuth.getInstance().getUid()).child("Pigeons");
        ...
        atx=findViewById(R.id.autoCompleteTextView);
